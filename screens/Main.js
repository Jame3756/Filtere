        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.categoryContainer}>
                    <TouchableOpacity onPress={()=>{this.setState({selected:"regular"})}} style={this.state.selected=="regular"?styles.categoryBoxSelected:styles.categoryBox}>
                        <Text>regular</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{this.setState({selected:"warfarer"})}} style={this.state.selected=="wayfarer"?styles.categoryBoxSelected:styles.categoryBox}>
                        <Text>wayfarer</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{this.setState({selected:"rimless"})}} style={this.state.selected=="rimless"?styles.categoryBoxSelected:styles.categoryBox}>
                        <Text>rimless</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{this.setState({selected:"round"})}} style={this.state.selected=="round"?styles.categoryBoxSelected:styles.categoryBox}>
                        <Text>round</Text>
                    </TouchableOpacity>
                    <TouchableOpacity  onPress={()=>{this.setState({selected:"aviator"})}}style={this.state.selected=="aviator"?styles.categoryBoxSelected:styles.categoryBox}>
                        <Text>aviator</Text>
                    </TouchableOpacity>
                </View>
